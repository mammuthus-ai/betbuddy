    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <div style={{ fontSize: 32, fontWeight: 900, letterSpacing: -1, animation: "slideUp 0.5s ease 0.2s both", background: "linear-gradient(135deg, #6c63ff, #ef476f, #ffd166)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Put Up or Shut Up</div>
          <div style={{
    ...
    <div style={{ minHeight: "100vh", background: "#0a0a0f", fontFamily: "'DM Sans', 'Helvetica Neue', Arial, sans-serif", color: "#fff" }}>
      ...
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div>
            <div style={{ fontSize: 18, fontWeight: 800, letterSpacing: -0.5, background: "linear-gradient(135deg, #6c63ff, #ef476f, #ffd166)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Put Up or Shut Up</div>
...
function FriendsView({ user, showToast }) {
  ...
  const handleInviteSMS = (phone) => {
    const message = encodeURIComponent("Join me on Put Up or Shut Up! Put your money where your mouth is. Download here: https://putuporshutup.app");
    if (window.Capacitor) {
          ...
          <div style={{ marginTop: 12 }}>
            {contactMatches.length > 0 && (
              <div style={{ marginBottom: 12 }}>
                <div style={{ fontSize: 12, color: "#52b788", fontWeight: 600, marginBottom: 8, textTransform: "uppercase", letterSpacing: 0.5 }}>On Put Up or Shut Up</div>
            ...
            {contactInvites.length > 0 && (
              <div>
                <div style={{ fontSize: 12, color: "#f2cc8f", fontWeight: 600, marginBottom: 8, textTransform: "uppercase", letterSpacing: 0.5 }}>Invite to Put Up or Shut Up</div>
  ...
  return (
    <div style={{ animation: "slideUp 0.3s ease" }}>
      <div style={{ marginBottom: 20 }}>
        ...
        <div style={{ fontSize: 13, color: "#888" }}>Upgrade your Put Up or Shut Up experience</div>
      </div>
